    ...
    <div className="flex h-screen flex-col overflow-y-auto bg-[color:var(--background)] text-[color:var(--foreground)]">
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-6 py-16 text-left">
        ...
        <p className="text-sm text-[color-mix(in_srgb,var(--foreground)_70%,transparent)]">
          ...
          version: your relationship notes stay private, and we collect only
        ...
        <div className="rounded-3xl border border-[color-mix(in_srgb,var(--foreground)_12%,transparent)] p-6 text-sm text-[color-mix(in_srgb,var(--foreground)_70%,transparent)] space-y-6">
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li>
                <strong>App data:</strong> Contact profiles, quick contacts,
                circles, notes, and reminders you enter in {APP_NAME}.
              </li>
              <li>
          ...
          <div>
            ...
            <p>
              Your relationship data is stored and displayed inside {APP_NAME}.
