...
const APP_NAME = "Networkia";
const APP_CONTACT_EMAIL = "serdar.dom@gmail.com";

export default function TermsPage() {
  return (
    <div className="flex h-screen flex-col overflow-y-auto bg-[color:var(--background)] text-[color:var(--foreground)]">
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-6 py-16 text-left">
        ...
        <div className="rounded-3xl border border-[color-mix(in_srgb,var(--foreground)_12%,transparent)] p-6 text-sm text-[color-mix(in_srgb,var(--foreground)_70%,transparent)] space-y-6">
          ...
          <div>
            ...
            <p>
              ...
              application for your personal or professional relationship
              management needs.
            </p>
          ...
          <div>
            ...
            <p>
              {APP_NAME} is offered free of charge. If we ever offer paid plans
              or tips, pricing will be clearly disclosed and optional.
            </p>
          </div>
          <div>
            <h2 className="text-xs uppercase tracking-[0.3em] text-[color-mix(in_srgb,var(--foreground)_55%,transparent)] mb-2">
            ...
            <p>
              Because the application is free, refunds are generally not
              applicable. If you experience an issue with any paid feature in
              the future, contact us at {APP_CONTACT_EMAIL}.
            </p>
          </div>
          <div>
            <h2 className="text-xs uppercase tracking-[0.3em] text-[color-mix(in_srgb,var(--foreground)_55%,transparent)] mb-2">
            ...
            <p>
              Access to the web application does not require payment. We reserve
              the right to suspend or terminate access for violation of these
          ...
          <div>
            ...
            <p>
              ...
              <a
                ...
                className="underline decoration-[color-mix(in_srgb,var(--foreground)_35%,transparent)] underline-offset-4 hover:text-[color:var(--foreground)]"
              >
                {APP_CONTACT_EMAIL}
              </a>
              .
        ...
        <Link
          href="/"
          className="text-xs uppercase tracking-[0.3em] text-[color-mix(in_srgb,var(--foreground)_60%,transparent)] transition hover:text-[color:var(--foreground)]"
        >
          ← Back to app
        </Link>
      </main>
